...
public class CheckHotels extends JFrame implements Runnable{
	...
	JLabel caption;
      ...
      public void run() {
    	  ...
    	  String[] text= new String[] {"JW Marriot Hotel","Mandarin Oriental Hotel","Four Seasons Hotel","Radisson Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blows Hotel","Quick Stop Hotel","Happy Mornings Motel","Moss View Hotel"};
